module github.com/seed95/forward-proxy
...
require (
	...
	gitlab.tasn.ir/ap/platform/common-components/microkit v0.2.26
	gitlab.tasn.ir/ap/website/backend/website v0.0.21-dev
